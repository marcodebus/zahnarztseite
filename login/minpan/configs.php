...
$pan_stock_folder = "zahnarzt-alzenau/assets/bilder"; # Main storage folder, if its not in root, folder name must be 'parent_folder/resources'
$pan_base = $_SERVER['DOCUMENT_ROOT'] . '/' . $pan_stock_folder;
...
$upl_allow_files = array('image/gif','image/jpeg','image/jpeg','image/png', 'application/pdf'); # Allowed file mime types (Full List: http://www.iana.org/assignments/media-types/media-types.xhtml)
?>