<?php
	...
	$visitor_data = $database -> query("SELECT * FROM analytics WHERE visitor_visitor_id='" . trim($_GET["visitor_visitor_id"]) . "'") -> fetchAll();




	$url = "http://ip-api.com/json/" . trim($_GET["visitor_ip"]);
	...
	foreach ($visitor_data as $visitor)
	{
		...
		if ($visitor["visitor_session_id"] == trim($_GET["visitor_session_id"]))
		{
	...
	$analytics["visitor_referrer_url"] = trim($_GET["visitor_referrer"]);
	$analytics["visitor_referrer_domain"] = get_domain(trim($_GET["visitor_referrer"]));
	$analytics["visitor_referrer_type"] = visitor_referrer_type(get_domain(trim($_GET["visitor_referrer"])));
	$analytics["visitor_referrer_name"] = visitor_referrer_name(get_domain(trim($_GET["visitor_referrer"])));


	// Dataset Page

	$analytics["visitor_domain"] = get_domain(trim($_GET["visitor_url"]));
	if (get_page(trim($_GET["visitor_url"])) != "" && get_page(trim($_GET["visitor_url"])) != " " && get_page(trim($_GET["visitor_url"])) != "&nbsp;")
	{
		$analytics["visitor_page_path"] = get_page(trim($_GET["visitor_url"]));
	}
	else
	{
	...
	$sql = "UPDATE analytics SET " . "visitor_visitor_last_page" . "='" . "" . "' WHERE " . "visitor_visitor_id" . "='" . trim($_GET["visitor_visitor_id"]) . "'";

	$database -> exec($sql); 


	$sql = "UPDATE analytics SET " . "visitor_session_last_page" . "='" . "" . "' WHERE " . "visitor_session_id" . "='" . trim($_GET["visitor_session_id"]) . "'";
	...
	$sql = "UPDATE analytics SET " . "visitor_visitor_sessions" . "='" . $analytics["visitor_visitor_sessions"] . "' WHERE " . "visitor_visitor_id" . "='" . trim($_GET["visitor_visitor_id"]) . "'";

	$database -> exec($sql); 


	$sql = "UPDATE analytics SET " . "visitor_visitor_pageviews" . "='" . $analytics["visitor_visitor_pageviews"] . "' WHERE " . "visitor_visitor_id" . "='" . trim($_GET["visitor_visitor_id"]) . "'";

	$database -> exec($sql); 


	$sql = "UPDATE analytics SET " . "visitor_visitor_pages" . "='" . $analytics["visitor_visitor_pages"] . "' WHERE " . "visitor_visitor_id" . "='" . trim($_GET["visitor_visitor_id"]) . "'";
	...
	$sql = "UPDATE analytics SET " . "visitor_session_pageviews" . "='" . $analytics["visitor_session_pageviews"] . "' WHERE " . "visitor_session_id" . "='" . trim($_GET["visitor_session_id"]);

	$database -> exec($sql); 


	$sql = "UPDATE analytics SET " . "visitor_session_pages" . "='" . $analytics["visitor_session_pages"] . "' WHERE " . "visitor_session_id" . "='" . trim($_GET["visitor_session_id"]);

	$database -> exec($sql); 


	$sql = "UPDATE analytics SET " . "visitor_session_landingpage" . "='" . $analytics["visitor_session_landingpage"] . "' WHERE " . "visitor_session_id" . "='" . trim($_GET["visitor_session_id"]);

	$database -> exec($sql); 


	$sql = "UPDATE analytics SET " . "visitor_session_exitpage" . "='" . $analytics["visitor_session_exitpage"] . "' WHERE " . "visitor_session_id" . "='" . trim($_GET["visitor_session_id"]);
