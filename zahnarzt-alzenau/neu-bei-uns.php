    ...
    <div class="container">
        ...
        <div class="row no-gutters">
            ...
            <div class="col-lg-12 py-3 py-lg-0"
                style="min-height:400px; background-color:white; background-position: top;">
                <div class="d-flex align-items-center h-100">
                    <div data-zanim-timeline="{}" data-zanim-trigger="scroll">

                        <h5 data-zanim='{"delay":0}'><?php echo lang('NeupatientenUeber');?></h5>
                        <img src="https://zahnarzt-fuchs-alzenau.de/zahnarzt-alzenau/assets/bilder/neu/begruesung.jpg"
                            style="border-radius:20px;">
                        <h6 class="color-7 fw-600" data-zanim='{"delay":0.1}'><?php echo lang('NeupatientenUUeber');?>
                        </h6>
...
<!--
            <div class="col-lg-7 px-5 py-6 my-lg-0 background-white radius-tr-lg-secondary radius-br-secondary
                ...
                <img style="background-color:white; border-radius:50%;" width="100%"
                    src="../assets/bilder/neu-bei-uns.jpeg">
                                ...
                                <div class="px-4">
                                    ...
                                    <div class="overflow-hidden">
                                        <p class="py-3 mb-0"><?php echo lang('NeupatientenDownloadUText1');?><br><br>
                                            <br><br><br><br><br>
                                            <a href="<?php echo lang('NeupatientenAnmeldebogenPfad');?>"
                                ...
                                <div class="px-4">
                                    ...
                                    <div class="overflow-hidden">
                                        <p class="py-3 mb-0">
                                            ...
                                            <br><br><br>
                                            <a href="<?php echo lang('NeupatientenChecklistePfad');?>"
                                                class="btn btn-icon btn-outline-primary btn-icon-left btn-capsule">
                                                <span class="icon-File-Download">
                                                </span><?php echo lang('Download');?>
                                            </a>
