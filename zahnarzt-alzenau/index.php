    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-10 col-md-9">
                ...
                <!--    <iframe width="100%" height="315" src="https://www.youtube.com/embed/uDbga9Kg8ew" frameborder="0"
...
-->
                ...
                <img class="radius-secondary" width="50%" title="Zahnarztpraxis Alzenau Dr. Bernhard Fuchs"
                    alt=" Zahnarzt Alzenau Dr. Bernhard Fuchs" src="<?php echo lang('begruesungsbild');?>" alt="" />
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-7 px-lg-5 mt-6 mt-lg-0 time-zon" data-zanim-timeline="{}" data-zanim-trigger="scroll">
                ...
                <div class="overflow-hidden">
                    <div class="" data-zanim='{"delay":0.1}'>
                        <h4 class="fs-0 fs-lg-1">
                            <img src="assets/bilder/icons/home.png" title="Zahnarzt Alzenau Dr. Bernhard Fuchs"
                                alt="Zahnarzt Alzenau Dr. Bernhard Fuchs" style=""><?php echo lang('Name');?>
                        </h4>
                    </div>
                </div>
                ...
                <div class="overflow-hidden">
                    <div class="" data-zanim='{"delay":0.1}'>
                        <h5 class="fs-0 fs-lg-1">
                            <img src="assets/bilder/icons/telefon.png" title="Zahnarzt Alzenau Dr. Bernhard Fuchs"
                                alt="Zahnarzt Alzenau Dr. Bernhard Fuchs" style=""><?php echo lang('Telefon');?>
                        </h5>
                ...
                <div class="overflow-hidden">
                    <div class="" data-zanim='{"delay":0.1}'>
                        <h5 class="fs-0 fs-lg-1">
                            <img src="assets/bilder/icons/fax.png" title="Zahnarzt Alzenau Dr. Bernhard Fuchs"
                                alt="Zahnarzt Alzenau Dr. Bernhard Fuchs" style=""><?php echo lang('Fax');?>
                        </h5>
                    </div>
                </div>
                ...
                <div class="overflow-hidden">
                    <div class="" data-zanim='{"delay":0.1}'>
                        <h5 class="fs-0 fs-lg-1">
                            <img src="assets/bilder/icons/mail.png" title="Zahnarzt Alzenau Dr. Bernhard Fuchs"
                                alt="Zahnarzt Alzenau Dr. Bernhard Fuchs" style=""><?php echo lang('Email');?>
                        </h5>
                    </div>
                </div>
                ...
                <div class="overflow-hidden">
                    <div class="" data-zanim='{"delay":0.1}'>
                        ...
                        <h5 class="fs-0 fs-lg-1">
                            ...
                            <img src="assets/bilder/icons/uhr.png" title="Zahnarzt Alzenau Dr. Bernhard Fuchs"
                                alt="Zahnarzt Alzenau Dr. Bernhard Fuchs" style=""><?php echo lang('Open');?>
                        </h5>
                        <div style="">
                            <div class="col-lg-12">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">
                    <h4>Corona Pandemie</h4> <br>
                    <h5 align="center">Erhöhte Sicherheitsmaßnahmen in unserer Praxis</h5>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary"><a
                        href="https://zahnarzt-fuchs-alzenau.de/zahnarzt-alzenau/corona.php" style="color: white;">Eine
                        Frage mit JA beantwortet</a></button>
            </div>
        </div>
    </div>
</div>
