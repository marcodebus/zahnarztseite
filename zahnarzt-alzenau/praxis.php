                ...
                <div class="container">
					...
					<div class="row no-gutters pos-relative mt-4 mt-lg-0">
                        ...
                        <div class="col-lg-6 py-3 py-lg-0 mb-0 order-lg-2" style="min-height:400px;">
                            <div class="background-holder radius-tl-secondary radius-tl-lg-0 radius-tr-secondary radius-tr-lg-0" style="background-image:url(<?php echo lang('BildPraxis');?>);"> </div>
                            <!--/.background-holder-->
                        </div>
                                ...
                                <div data-zanim-timeline="{}" data-zanim-trigger="scroll">
                                    ...
                                    <div class="overflow-hidden">
                                        <div data-zanim='{"delay":0.2}'>
                                            <a class="d-flex align-items-center" href="angstpatient-lachgas-tiefschlaf-vollnarkose.php">
