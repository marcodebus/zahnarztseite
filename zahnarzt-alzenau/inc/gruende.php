       ...
       <div class="col-lg-6 px-lg-5 mt-6 mt-lg-0" data-zanim-timeline="{}" data-zanim-trigger="scroll">
		   	...
		   	<div class="overflow-visible">
                                <div class="px-4 px-sm-0 mt-5" data-zanim='{"delay":0.2}'>
                                     <div style="margin-bottom: 10px; padding:10px">
										 <h5 class="fs-0 fs-lg-1">
                                       <!--<span class="ion-ios-timer fs-2 mr-2 icon-position-fix fw-600"></span>--><img src="assets/bilder/icons/geld.png" style="margin-right: 10px; margin-left: 10px;float:left; ">Hochwertiger Zahnersatz</h5>	<p class="mt-3 px-lg-3">zu günstigen Preisen mit Möglichkeit der Ratenzahlung<br><br></p>
