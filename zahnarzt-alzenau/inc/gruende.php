							...
							<div class="overflow-visible">
                                <div class="px-4 px-sm-0 mt-5" data-zanim='{"delay":0.2}'>
                                     <div style="margin-bottom: 10px; padding:10px">
                                       ...
                                       <!--<span class="ion-ios-timer fs-2 mr-2 icon-position-fix fw-600"></span>--><img src="assets/bilder/icons/team.png" style="margin-right: 10px; margin-left: 10px;float:left;">Tätigkeitsschwerpunkt Ästhetische Zahnheilkunde:</h5>
										 </div>
                                ...
                                <div class="px-4 px-sm-0 mt-5" data-zanim='{"delay":0.2}'>
                                     <div style="margin-bottom: 10px; padding:10px">
                                       ...
                                       <!--<span class="ion-ios-timer fs-2 mr-2 icon-position-fix fw-600"></span>--><img src="assets/bilder/icons/fahne.png" style="margin-right: 10px; margin-left: 10px;float:left;">Wir sprechen Ihre Sprache:<br></h5>
										...
										<p class="mt-3 px-lg-3"><br>Wir sprechen 5 Sprachen: <br>Deutsch, Englisch, Türkisch, Französisch und Rumänisch. </p><p align="right"><a class="btn btn-icon btn-outline-primary btn-icon-left " href="team.php">
										<span class="icon-Tooth "></span>Mehr Erfahren</a></p>
