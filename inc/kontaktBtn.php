<div class="col-lg-12 px-lg-12 mt-6 mt-lg-0" data-zanim-timeline="{}" data-zanim-trigger="scroll">
							 ...
							 <div class="overflow-hidden" style="margin: 10px;">
                                <div class="px-4 px-sm-0 mt-5" data-zanim='{"delay":0.1}'>
                                      ...
                                      <img src="assets/bilder/icons/blankPNG.png" style=""><br><br></h5>
                                </div>
                            </div>
							 ...
							 <div class="overflow-hidden" style="margin: 10px;">
                                <div class="" data-zanim='{"delay":0.1}'>
                                   <h5 class="fs-0 fs-lg-1">
                                   <img src="assets/bilder/icons/home.png" style=""><nobr><?php echo lang('Name');?></nobr></h5>
							...
							<div class="overflow-hidden" style="margin: 10px;">
                                <div class="" data-zanim='{"delay":0.1}'>
                                   <h5 class="fs-0 fs-lg-1">
                                   <img src="assets/bilder/icons/telefon.png" style=""><?php echo lang('Telefon');?></h5>
							...
							<div class="overflow-hidden" style="margin: 10px;">
                                <div class="" data-zanim='{"delay":0.1}'>
                                     	...
                                     	<img src="assets/bilder/icons/mail.png" style=""><nobr><?php echo lang('Email');?></nobr></h5>
                                </div>
                            </div>
